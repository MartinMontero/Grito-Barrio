...
export interface LegalTriageData {
  ...
  // Occupant Category
  occupantCategory: 'formal_tenant' | 'informal' | 'indigenous_collective' | 'subtenant' | 'unknown'
...
export const FORM_TEMPLATES: Record<FormType, { title: string; description: string }> = {
  incident_report: {
