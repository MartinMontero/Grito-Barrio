...
export type SafePointType = 'church' | 'community_center' | 'school' | 'private' | 'public' | 'other'

export type SafePointStatus = 'active' | 'inactive' | 'pending' | 'full' | 'maintenance'
...
export const SAFE_POINT_TYPES: Record<SafePointType, { label: string; icon: string; color: string }> = {
  church: { label: 'Iglesia', icon: 'Church', color: 'bg-purple-500' },
  community_center: { label: 'Centro Comunitario', icon: 'Users', color: 'bg-blue-500' },
...
export const RESOURCE_CATEGORIES: Record<ResourceCategory, { label: string; icon: string; color: string }> = {
  agua_alimentos: { label: 'Agua y Alimentos', icon: 'Droplets', color: 'bg-blue-500' },
  primeros_auxilios: { label: 'Primeros Auxilios', icon: 'Heart', color: 'bg-red-500' },
  seguridad: { label: 'Equipo de Seguridad', icon: 'Shield', color: 'bg-gray-700' },
  documentacion: { label: 'Documentación', icon: 'FileText', color: 'bg-yellow-500' },
  comunicaciones: { label: 'Comunicaciones', icon: 'Radio', color: 'bg-green-500' },
...
export const RESOURCE_LEVELS: Record<ResourceLevel, { label: string; description: string; capacity: string }> = {
  basico: { label: 'Básico', description: '2-5 personas', capacity: '2-5 personas' },
  medio: { label: 'Medio', description: '10-30 personas', capacity: '10-30 personas' },
  robusto: { label: 'Robusto', description: 'Coalición completa', capacity: '30+ personas' }
}
