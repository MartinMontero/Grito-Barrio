...
export const CERTIFICATION_LEVELS: Record<
  CertificationLevel,
  { title: string; hours: number; color: string }
> = {
...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    id: "level_2_complete",
    title: "Especialista",
    description: "Completa el Nivel 2",
    icon: "🛡️",
    isUnlocked: false,
  },
  {
    id: "level_3_complete",
    title: "Líder",
    description: "Completa el Nivel 3",
    icon: "👑",
    isUnlocked: false,
  },
  {
  ...
  {
    id: "scenario_master",
    title: "Maestro de Escenarios",
    description: "Completa 10 escenarios",
    icon: "🎭",
    isUnlocked: false,
  },
  {
    id: "speed_demon",
    title: "Velocista",
    description: "Completa un escenario en tiempo récord",
    icon: "⚡",
    isUnlocked: false,
  },
  {
    id: "streak_7",
    title: "Constancia",
    description: "7 días de actividad consecutiva",
    icon: "🔥",
    isUnlocked: false,
  },
];
