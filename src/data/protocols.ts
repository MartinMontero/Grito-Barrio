...
export const protocols: Protocol[] = [
  {
    ...
    description: 'Medidas preventivas para evitar desalojos ilegales antes de que ocurran',
    isEmergency: false,
    steps: [
      {
        id: 'p1-s1',
        ...
        description: 'Reúne y guarda en lugar seguro todos los documentos que acrediten tu residencia y derechos de ocupación.',
        actions: [
      ...
      },
      {
        ...
        description: 'Mantén canales de comunicación abiertos y documenta todas las interacciones.',
        actions: [
      ...
      },
      {
        ...
        description: 'Infórmate sobre tus derechos como inquilino u ocupante legal.',
        actions: [
    ...
    steps: [
      {
        ...
        description: 'Si hay presencia de fuerza pública o particulares intentando desalojar, actúa de inmediato.',
        actions: [
      ...
      },
      {
        ...
        description: 'Activa inmediatamente tus contactos de emergencia y organizaciones de apoyo.',
        actions: [
...
export const externalResources: Resource[] = [
  {
    ...
    description: 'Asesoría y representación legal gratuita para personas sin recursos',
    contact: {
      phone: '555-009-2600',
