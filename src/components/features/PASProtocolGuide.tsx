...
const EMERGENCY_CONTACTS = [
  ...
  {
    id: "erum" as EmergencyContact,
    name: "ERUM",
    number: "55-5683-2222",
    color: "bg-orange-600",
  },
  {
    id: "cruz-roja" as EmergencyContact,
    name: "Cruz Roja",
    number: "55-5557-5757",
    color: "bg-blue-600",
  },
...
const STEP_CONTENT = {
  proteger: {
    ...
    color: "blue",
    description:
      "Evaluación de seguridad de la escena: yo, transeúntes, sobreviviente",
    items: [
    ...
    warning:
      "⚠️ Sin asistencia si la escena no está segura. Tu seguridad es primero.",
  },
  avisar: {
    title: "Avisar",
    color: "yellow",
  ...
  socorrer: {
    ...
    warnings: [
      "⚠️ Sin procedimientos invasivos",
      "⚠️ Sin administración de medicamentos",
    ],
  },
};
...
export const PASProtocolGuide: React.FC<PASProtocolGuideProps> = ({
  ...
  useEffect(() => {
    const t = setTimeout(
      () => store.saveProtocolDraft(draftKey, checklist),
      300,
    );
  ...
  const stepNumber =
    currentStep === "proteger" ? 1 : currentStep === "avisar" ? 2 : 3;
  ...
  const callEmergency = (contactId: EmergencyContact) => {
    ...
    if (contact)
      window.location.href = `tel:${contact.number.replace(/-/g, "")}`;
  };
      ...
      <header className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 sticky top-0 z-50">
        <div className="max-w-lg mx-auto px-4 py-4">
          ...
          <div className="flex justify-between">
            {(["proteger", "avisar", "socorrer"] as PASStep[]).map(
              (step, idx) => (
                <button
                  key={step}
          ...
          <CardContent className="p-4 space-y-4">
            ...
            {"warnings" in stepConfig && stepConfig.warnings && (
              <div className="space-y-2">
                {(stepConfig.warnings as string[]).map(
                  (w: string, i: number) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    {contact.alt && (
                      <div className="text-sm opacity-90">o {contact.alt}</div>
                    )}
                  </div>
                ...
                <div
                  className={cn(
                    ...
                    item.checked
                      ...
                      : cn("border-2", c.border.replace("border-", "border-")),
                  )}
                >
          ...
          <div className="space-y-3">
            ...
            {Object.entries(REFERENCE_CARDS).map(([key, card]) => {
              ...
              return (
                <div
                  key={key}
                  className={cn("border rounded-lg overflow-hidden", cc.border)}
                >
                  <button
