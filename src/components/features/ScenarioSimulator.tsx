...
const MOCK_SCENARIOS: Scenario[] = [
  {
    ...
    description: 'Un desalojo inesperado en horario nocturno con presencia de grupos armados.',
    difficulty: 'hard',
    category: 'Seguridad',
    estimatedTime: 15,
    ...
    stages: [
      {
        ...
        description: 'Llegas a la escena a las 3:00 AM. Hay personas armadas en la entrada.',
        situation: 'Observas 3 individuos con armas largas en la puerta principal. Hay familias con niños dentro del inmueble.',
        options: [
          {
            id: 'opt-1',
            text: 'Acercarse directamente para hablar con los agresores',
            consequence: 'Demasiado peligroso. Los agresores te amenazan con las armas.',
            isCorrect: false,
            score: 0
          },
          {
            ...
            consequence: 'Correcto. Identificas puntos de riesgo y rutas de escape.',
            isCorrect: true,
            score: 100
          },
          {
            ...
            consequence: 'Prematuro. Primero debes asegurar la seguridad de las personas.',
            isCorrect: false,
            score: 25
          }
        ],
      ...
      },
      {
        id: 'stage-2',
        title: 'Comunicación',
        description: 'Necesitas establecer contacto con las familias afectadas.',
        situation: 'Las familias están asustadas y no saben si confiar en brigadistas desconocidos a esta hora.',
        options: [
          {
            id: 'opt-1',
            text: 'Gritar desde la calle que son de la brigada',
            consequence: 'No funciona. El ruido y el miedo hacen que no te escuchen.',
            isCorrect: false,
            score: 10
          },
          {
            ...
            consequence: 'Excelente. Las familias reconocen la señal y responden.',
            isCorrect: true,
            score: 100
          },
          {
            ...
            consequence: 'Riesgoso. Podrías encontrar más agresores o ser confundido con uno de ellos.',
            isCorrect: false,
            score: 30
          }
        ],
      ...
      },
      {
        ...
        description: 'Las familias están seguras temporalmente pero la situación es grave.',
        situation: 'Las familias están agrupadas en una habitación interior. Los agresores están cada vez más violentos.',
        options: [
          {
            id: 'opt-1',
            text: 'Confrontar a los agresores para defender el inmueble',
            consequence: 'Extremadamente peligroso. No es el rol de la brigada confrontar físicamente.',
            isCorrect: false,
            score: 0
          },
          {
            ...
            consequence: 'Correcto. La seguridad de las personas es lo primero.',
            isCorrect: true,
            score: 100
          },
          {
            ...
            consequence: 'Peligroso. No sabes cuándo llegarán y la situación se deteriora.',
            isCorrect: false,
            score: 40
          }
        ],
  ...
  },
  {
    ...
    description: 'Un desalojo con orden judicial durante el día con presencia de medios.',
    difficulty: 'medium',
    ...
    stages: [
      {
        ...
        situation: 'El actuario muestra documentos pero la comunidad duda de su autenticidad.',
        options: [
          {
            id: 'opt-1',
            text: 'Ignorar los documentos y negar el acceso',
            consequence: 'Ilegal. Si la orden es válida, estás obstruyendo la justicia.',
            isCorrect: false,
            score: 20
          },
          {
            ...
            consequence: 'Correcto. Identificas inconsistencias en la documentación.',
            isCorrect: true,
            score: 100
          },
          {
    ...
    stages: [
      {
        id: 'stage-1',
        title: 'Documentación',
        description: 'Los vecinos reportan corte de servicios sin previo aviso.',
        situation: '20 familias sin agua ni luz por 3 días. Hay niños y adultos mayores afectados.',
        options: [
          {
            id: 'opt-1',
            text: 'Documentar todo y presentar queja ante CDHCM',
            consequence: 'Correcto. Esto es una violación a derechos humanos documentable.',
            isCorrect: true,
            score: 100
          },
          {
            ...
            consequence: 'Ineficiente. La empresa probablemente actúa por órdenes del dueño.',
            isCorrect: false,
            score: 50
          },
          {
  ...
  if (activeScenario) {
    return (
      <ActiveScenario
        ...
        onComplete={(score, time) => handleCompleteScenario(activeScenario.id, score, time)}
          ...
          <Card>
            <CardContent className="p-3 text-center">
              <p className="text-2xl font-bold">
                {Object.values(progress).reduce((max, p) => Math.max(max, p.bestScore), 0)}%
              </p>
...
const ScenarioCard: React.FC<ScenarioCardProps> = ({ scenario, progress, onStart }) => {
...
const ActiveScenario: React.FC<ActiveScenarioProps> = ({ scenario, onComplete, onExit }) => {
