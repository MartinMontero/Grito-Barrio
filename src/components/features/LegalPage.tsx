...
const categoryIcons: Record<LegalCategory, React.ComponentType<{ className?: string }>> = {
  rights: Shield,
  laws: Gavel,
  procedures: FileText,
  defenses: Scale,
...
export function LegalPage({ onResourceSelect }: LegalPageProps) {
  const groupedResources = legalResources.reduce((acc, resource) => {
  ...
  return (
    <div className="space-y-4 pb-20">
      ...
      <div className="px-4 pt-2">
        ...
        <p className="text-muted-foreground">Conoce tus derechos y las leyes que te protegen</p>
      </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-amber-700 mt-1">
                La información proporcionada es orientativa y no sustituye el asesoramiento 
                legal profesional. Consulta siempre con un abogado o defensor especializado.
              </p>
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                <CardContent className="p-4">
                  <div className={cn("w-10 h-10 rounded-lg flex items-center justify-center mb-2", colorClass)}>
        ...
        <Card className="bg-primary/5 border-primary/20">
          ...
          <CardContent>
            <ul className="space-y-2">
              ...
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                <span className="text-sm">Prohibición de desalojo sin orden judicial</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
              ...
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
                <span className="text-sm">Derecho a asesoría legal gratuita</span>
              </li>
              <li className="flex items-start space-x-2">
                <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2" />
