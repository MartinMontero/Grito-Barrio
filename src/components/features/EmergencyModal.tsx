            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData((prev) => ({
                    ...prev,
                    alertSource: value as AlertSource,
                  }))
                }
              >
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="community_network">
                    Red Comunitaria
                  </SelectItem>
                  <SelectItem value="social_media">Redes Sociales</SelectItem>
                  <SelectItem value="legal_aid">Asistencia Legal</SelectItem>
                  <SelectItem value="government_notice">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setFormData((prev) => ({
                    ...prev,
                    threatLevel: value as ThreatLevel,
                  }))
                }
              >
                <SelectTrigger>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="moderate">
                    Moderado - Precaución necesaria
                  </SelectItem>
                  <SelectItem value="high">
                    Alto - Riesgo significativo
                  </SelectItem>
                  <SelectItem value="critical">
                    Crítico - Peligro inmediato
                  </SelectItem>
                  <SelectItem value="extreme">
                    Extremo - Evacuación inmediata
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    occupantsAtRisk: parseInt(e.target.value) || 1,
                  }))
                }
              />
            </div>
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...prev,
                      minorsPresent: e.target.checked,
                    }))
                  }
                />
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...prev,
                      vulnerablePersons: e.target.checked,
                    }))
                  }
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">
                  Personas vulnerables (adultos mayores, discapacitados)
                </span>
              </label>
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setFormData((prev) => ({
                      ...prev,
                      authoritiesPresent: e.target.checked,
                    }))
                  }
                />
                <span className="text-sm text-gray-700 dark:text-gray-300">
        ...
        <div className="px-4 py-3">
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3">
            <p className="text-xs text-amber-800">
              <strong>Recuerda:</strong> Tu seguridad es lo primero. No
              confrontes físicamente. Documenta todo y busca ayuda profesional.
            </p>
          </div>
        </div>
