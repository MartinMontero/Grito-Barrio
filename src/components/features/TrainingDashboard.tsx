...
export const TrainingDashboard: React.FC<TrainingDashboardProps> = ({
  ...
  const stats = useMemo(() => {
    ...
    const nextLevelRequirements =
      CERTIFICATION_LEVELS[
        (progress.certificationLevel + 1) as CertificationLevel
      ];
    const hoursNeeded = nextLevelRequirements
      ? nextLevelRequirements.hours - progress.totalHoursCompleted
      : 0;
    ...
    return {
      ...
      canLevelUp:
        ...
        progress.modulesCompleted >=
          getModulesForLevel(progress.certificationLevel + 1),
    };
  }, [modules, progress]);
        ...
        {stats.canLevelUp && (
          <Alert className="mx-4 mb-4 bg-green-50 border-green-200">
            ...
            <AlertDescription className="text-green-700">
              Has completado todos los requisitos para el Nivel{" "}
          ...
          <ScrollArea className="flex-1">
            ...
            <TabsContent value="overview" className="p-4 space-y-4 mt-0">
                    ...
                    <div className="flex items-start gap-4">
                      <div
                        className={cn(
                          ...
                          MODULE_CATEGORIES[nextModule.category].color.split(
                            " ",
                          )[0],
                        )}
                      >
              ...
              <div className="space-y-3">
                ...
                {[1, 2, 3].map((level) => {
                  const levelInfo =
                    CERTIFICATION_LEVELS[level as CertificationLevel];
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                ...
                {[1, 2, 3].map((level) => (
                  <Button
                    ...
                    size="sm"
                    onClick={() =>
                      setSelectedLevel(level as CertificationLevel)
                    }
                  >
                    Nivel {level}
                  </Button>
            ...
            <TabsContent value="achievements" className="p-4 mt-0">
              <div className="grid grid-cols-2 gap-3">
                {achievements.map((achievement) => (
                  <Card
                    key={achievement.id}
                    className={cn(!achievement.isUnlocked && "opacity-50")}
                  >
                    <CardContent className="p-4 text-center">
