...
export const CHAIN_OF_CUSTODY_TEMPLATE: FormTemplate = {
      ...
      fields: [
        {
          ...
          placeholder:
            "Fecha | Hora | Persona | Acción | Razón | Ubicación | Método",
          helpText:
            "Documentar cada acceso: quién, cuándo, por qué, desde dónde",
          required: true,
        },
      ],
    },
  ...
  footer:
    "Esta cadena de custodia garantiza la integridad y autenticidad de la evidencia documentada.",
  legalNotice:
    "DOCUMENTO LEGAL: Esta cadena de custodia es un registro legal que documenta la integridad de la evidencia. Cualquier ruptura en la cadena puede afectar la validez legal de la evidencia.",
};
...
export const PAS_EVALUATION_TEMPLATE: FormTemplate = {
  ...
  footer:
    "La evaluación P.A.S. garantiza que se siguieron todos los protocolos de respuesta a emergencias.",
  legalNotice:
    "PROTOCOLO ESTÁNDAR: Esta evaluación sigue el protocolo internacional P.A.S. (Proteger-Avisar-Socorrer) para respuesta a emergencias.",
};
...
export const LEGAL_TRIAGE_TEMPLATE: FormTemplate = {
      ...
      fields: [
        {
          ...
          label: "Contactos",
          placeholder:
            "Organización | Persona | Hora | Método | Respuesta | Prioridad",
        },
      ],
    },
    {
  ...
  footer:
    "Este triage legal proporciona una evaluación inicial para determinar la mejor ruta legal.",
  legalNotice:
    "NOTA: Este triage es una evaluación preliminar y no constituye asesoría legal completa. Se recomienda consultar con un abogado especializado.",
};
...
export const CHECKLIST_60MIN_TEMPLATE: FormTemplate = {
  ...
  footer:
    "Este checklist garantiza que todas las acciones críticas se realicen dentro de la primera hora de respuesta.",
  legalNotice:
    "PROTOCOLO DE TIEMPO CRÍTICO: La primera hora es crucial para la documentación legal efectiva y la seguridad de los ocupantes.",
};
