...
export const ROLE_DEFINITIONS: Record<TeamRole, RoleDefinition> = {
  leader: {
    ...
    quickAccess: [
      ...
      { id: 'incidents', label: 'Incidentes', icon: AlertTriangle, path: '/incidents', badge: 0 },
      { id: 'contacts', label: 'Contactos', icon: Phone, path: '/contacts', badge: 0 },
      { id: 'reports', label: 'Reportes', icon: FileText, path: '/reports', badge: 0 }
    ],
    dashboardWidgets: [
      {
        id: 'team-status',
  ...
  security: {
    ...
    quickAccess: [
      ...
      { id: 'threats', label: 'Amenazas', icon: AlertTriangle, path: '/security/threats' },
      { id: 'withdrawal', label: 'Retirada', icon: LogOut, path: '/security/withdrawal' },
      { id: 'deescalation', label: 'Desescalada', icon: MessagesSquare, path: '/security/deescalation' }
    ],
    dashboardWidgets: [
      {
        id: 'threat-checklist',
  ...
  medical: {
    ...
    quickAccess: [
      ...
      { id: 'injuries', label: 'Lesiones', icon: Stethoscope, path: '/medical/injuries' },
  ...
  legal: {
    ...
    quickAccess: [
      ...
      { id: 'evidence', label: 'Evidencia', icon: Camera, path: '/evidence/collect' },
      { id: 'forms', label: 'Formularios', icon: FileText, path: '/legal/forms' },
      { id: 'contacts', label: 'Legales', icon: Phone, path: '/contacts/legal' }
    ],
    dashboardWidgets: [
      {
        id: 'legal-triage',
  ...
  dispatch: {
    ...
    quickAccess: [
      { id: 'contacts', label: 'Contactos', icon: Phone, path: '/contacts/tree' },
      { id: 'alerts', label: 'Alertas', icon: Bell, path: '/dispatch/alerts' },
      { id: 'coalition', label: 'Coalición', icon: Share2, path: '/contacts/coalition' },
      { id: 'templates', label: 'Plantillas', icon: FileText, path: '/dispatch/templates' }
    ],
    dashboardWidgets: [
      {
        id: 'contact-tree',
  ...
  logistics: {
    ...
    quickAccess: [
      { id: 'supplies', label: 'Suministros', icon: Package, path: '/logistics/supplies' },
      { id: 'safepoints', label: 'Puntos Seguros', icon: MapPin, path: '/logistics/safepoints' },
      { id: 'shelter', label: 'Albergue', icon: Warehouse, path: '/logistics/shelter' },
      { id: 'tracking', label: 'Seguimiento', icon: Activity, path: '/logistics/tracking' }
    ],
    dashboardWidgets: [
      {
        id: 'supply-status',
...
export function getRoleIcon(role: TeamRole): React.ComponentType<{ className?: string }> {
