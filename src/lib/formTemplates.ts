...
import { ALCALDIAS } from "@/types/forms";
...
export const INCIDENT_REPORT_TEMPLATE: FormTemplate = {
      ...
      fields: [
        {
          ...
          required: true,
          helpText:
            "Incluir hora, decisión, quién la tomó y base de información",
        },
        {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder:
            "Persona | Naturaleza | Severidad | Atención proporcionada | Referencia",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder:
            "Seudónimo | Contacto seguro | Qué observó | Disponibilidad",
  ...
  footer:
    "Este reporte es un documento legal que forma parte de la documentación del incidente. La información proporcionada debe ser veraz y completa.",
  legalNotice:
    "AVISO LEGAL: Este documento es confidencial y está protegido por las leyes de protección de datos personales. El uso indebido de esta información puede resultar en sanciones legales.",
};
...
export const WITNESS_STATEMENT_TEMPLATE: FormTemplate = {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          placeholder:
            "Ej: Plena luz del día, atardecer, noche con alumbrado público",
        },
        {
          id: "obstacles",
          type: "text",
      ...
      fields: [
        {
          ...
          placeholder:
            "Describa las personas presentes: vestimenta, comportamiento, roles...",
          required: true,
        },
        {
          id: "occupantsCount",
      ...
      fields: [
        {
          ...
          helpText:
            "Documentar exactamente lo que escuchó, entre comillas si es posible",
        },
        {
      ...
      fields: [
        {
          ...
          required: true,
          helpText:
            "Transcripción completa de lo que el testigo declara haber observado",
        },
        {
          id: "statementClarity",
          type: "select",
      ...
      fields: [
        {
          ...
          type: "checkbox",
          label:
            "El testigo da su consentimiento para el uso de esta información",
          required: true,
        },
        {
          id: "consentDate",
  ...
  footer:
    "Esta declaración es un testimonio voluntario proporcionado por el testigo. La información debe ser tratada con confidencialidad.",
  legalNotice:
    "AVISO: Este documento es un testimonio que puede ser utilizado en procedimientos legales. La falsedad en declaraciones puede constituir un delito.",
};
